...
%                 '%1.2f',    c.results.Left.momentMin_OppStrike_100.LHip(1)
                ...
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Thorax(1) 
                '%1.2f'     c.results.Right.angAtFoot_Strike.RThorax(1)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LThorax(1)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Pelvis(1)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RPelvis(1)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LPelvis(1)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Knee(1)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RKnee(1)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LKnee(1)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Ankle(1)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RAnkle(1)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LAnkle(1)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.FootProgress(1)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RFootProgress(1)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LFootProgress(1)
                % Angle à l'attaque en frontal
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Thorax(2) 
                '%1.2f'     c.results.Right.angAtFoot_Strike.RThorax(2)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LThorax(2)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Pelvis(2)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RPelvis(2)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LPelvis(2)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Knee(2)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RKnee(2)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LKnee(2)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Ankle(2)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RAnkle(2)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LAnkle(2)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.FootProgress(2)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RFootProgress(2)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LFootProgress(2)
                % Angle à l'attaque en transverse
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Thorax(3) 
                '%1.2f'     c.results.Right.angAtFoot_Strike.RThorax(3)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LThorax(3)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Pelvis(3)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RPelvis(3)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LPelvis(3)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Knee(3)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RKnee(3)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LKnee(3)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.Ankle(3)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RAnkle(3)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LAnkle(3)
                '%1.2f'     c.results.MeanLeg.angAtFoot_Strike.FootProgress(3)
                '%1.2f'     c.results.Right.angAtFoot_Strike.RFootProgress(3)
                '%1.2f'     c.results.Left.angAtFoot_Strike.LFootProgress(3)
